...
use crate::msg::paircontract::{InitMsg, HandleMsg, InvokeMsg};
...
pub fn init<S: Storage, A: Api, Q: Querier>(
    ...
    messages.push(CosmosMsg::Wasm(WasmMsg::Instantiate {
        ...
        msg: to_binary(&Snip20ComposableMsg {
            ...
            symbol: "SWAP-Contract".to_string(),
            decimals: 18,
...
pub fn handle<S: Storage, A: Api, Q: Querier>(
    ...
    match msg {
        ...
        HandleMsg::AddLiquidityToPairContract {
            deposit,
...
fn initial_swap(
    ...
    let mut token0_pool = tokens_balances[index];
    let mut token1_pool = tokens_balances[index ^ 1];
...
fn remove_liquidity<S: Storage, A: Api, Q: Querier>(
    ...
    let mut pool_balances = pair.query_balances(&deps.querier, contract_addr, viewing_key.0)?;
